			...
			<div class="col-md-3 product-men">
				<div class="men-pro-item simpleCart_shelfItem">
					<div class="men-thumb-item">
						...
						<span class="product-new-top">${pd.other }</span> <span
							class="item-right"> <c:forEach items="${listob }"
								var="item">
					...
					<div class="item-info-product">
						...
						<br>
						<a href="/user/conf/add/${pd.id}" class="btn btn-primary">So sánh</a>
					</div>
				</div>
			</div>
		</c:if>
