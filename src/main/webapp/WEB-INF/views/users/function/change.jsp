	...
	<div class="row">
		<div class="col-sm-4">
			...
			<li class="nav-item2 " style="list-style-type: none;"><a
				class="nav-link collapsed" href="/user/account/edit/${sessionScope.user.username }"
		...
		<div class="col-sm-8">
			<div class="ct1">
				<div>
					...
					<form action="/user/account/change" method="post"
						...
						<div class="row">
							...
							<div class="col-sm-8">
								<p>
									<input style="width: 90%;" name="username"
							...
							<div class="col-sm-8">
								<p>
									<input name="pw" type="password"
										class="form-control" style="width: 90%;" required="required"
