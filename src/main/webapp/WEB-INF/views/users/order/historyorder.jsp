	...
	<div class="row">
		<div class="col-sm-4">
			...
			<li class="nav-item2 " style="list-style-type: none;"><a
				...
				href="/user/account/edit/${sessionScope.user.username }"
		...
		<c:choose>
			<c:when test="${historyorder.size()!= 0}">
				<div class="col-sm-8">
					<div class="ct1">
						<div>
							...
							<table class="table table-striped table-bordered table-hover"
								...
								<tbody>
									<c:forEach var="o" items="${historyorder}">
										<tr>
											<td>${o.id}</td>
											<td><fmt:formatDate type="date" dateStyle="short"
													timeStyle="short" value="${o.created}" /></td>
											<td>${o.address }</td>
											<td><f:formatNumber value="${o.total}" pattern="#,###" />
												VNĐ</td>
											<td><a href="/user/order/detail/${o.id}"
			...
			<c:otherwise>
				<br>
				<div class="col-md-5 md-offset-2">
					<div class="alert alert-warning"
						style="font-weight: bold; font-size: 20px">Không có bất cứ
						sản phẩm nào đã mua!</div>
					<a href="/user/home" class="btn btn-danger">Mua ngay thôi!</a>
				</div>
			</c:otherwise>
		</c:choose>
	</div>
