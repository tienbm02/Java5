			...
			<div class="col-lg-12">
				<div class="card">
					<div class="card-body">
						...
						<hr>
						<form:form method="post" action="${url }/product/update"
							...
							<div class="form-group">
								...
								<form:input path="price" type="number" class="form-control" required="required"
									step="1000" min="10000" id="path" placeholder="Giá"  value="${gia }"/>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="input-group">
									<form:input path="discount" class="form-control" type="number"
										id="discount" step="1" min="0" max="100" 
										placeholder="Giảm ... %" />
							...
							<div class="form-footer">
								<a href="/admin/product" class="btn btn-danger"> <i
